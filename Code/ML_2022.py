...
#%%Prédiction
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R24.csv",sep = ",")
...
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.32€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.49€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.32€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_24.csv', sep=',', encoding='utf-8')
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R11.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.36€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 6.14€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 8.26 du m²
Fusion_1_Pred = Fusion_1_Pred.drop(columns=['Dep'])
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_11_1.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R11_75.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.71€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 8.68€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 9.26€ du m²
Fusion_1_Pred = Fusion_1_Pred.drop(columns=['Dep'])
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_Paris.csv', sep=',', encoding='utf-8', index=False)
...
print('R² is: '+str(round(r2_score(y_test,model.predict(X_test)),2)))
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R27.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.69 du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.62€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.20€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_27.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R28.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.72€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.83€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.52€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_28.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R32.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.28
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min:  5.72
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.44
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_32.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R44.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)]
...
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.32€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.78€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.17€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_44.csv', sep=',', encoding='utf-8', index=False)

#%% Alsace Moselle
import matplotlib.pyplot as plt
import matplotlib.ticker as mtick
from sklearn.preprocessing import scale
Alsace_Lorraine = pd.read_excel('C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Prix communes Alsace Moselle.xlsx',
                                sheet_name = 'Appartements')
Fusion = pd.concat([Fusion_d01_d21, Fusion_d22_d40, Fusion_d41_d60, Fusion_d61_d80, Fusion_d81_d974], axis = 0)

Fusion['pm2'] = Fusion['valeurfonc']/Fusion['ffshab']
Moyenne = Fusion.groupby('ffshab').median()
Moyenne.to_excel(r'PM2.xlsx', index = True)

y = scale(Moyenne['pm2'])
X = scale(Moyenne.index.values)
plt.plot(X,y, color='black', linewidth=2, label="")
plt.xlim(9, 250)
plt.ylim(250,10000)
plt.show()
...
Fusion_1_Pred = Fusion_1_Pred.drop('Dep', axis=1)
Fusion_1_Pred = Fusion_1_Pred[(Fusion_1_Pred['dteloc'] == 2)]
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R52.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.01 du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.57 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.70€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_52.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R53.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.87€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.94 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.69€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_53.csv', sep=',', encoding='utf-8', index=False)
#%%
#%%Nouvelle Aquitaine
Fusion = pd.concat([Fusion_d01_d21, Fusion_d22_d40, Fusion_d41_d60, Fusion_d61_d80, Fusion_d81_d974], axis = 0)
Fusion['ffcodinsee'] = Fusion['ffcodinsee'].apply(lambda x: '{0:0>5}'.format(x))
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R75.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.78€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.66 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.57€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_75.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R76.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max:  8.61
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.94
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.54
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_76.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R84.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.71€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.98 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.72 du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_84.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R93.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.36
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 6.71
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 8.04
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_93.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R94.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.63€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 6.85 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.91€ du m²
Fusion_1_Pred = Fusion_1_Pred[(Fusion_1_Pred['Predicted_price_sq_m'] > 0)]
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_94.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R01.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.47
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 4.97
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.59
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_01.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R02.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.41
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 6.58
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.58
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_02.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2022/R04.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.88
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.50
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.74
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_04.csv', sep=',', encoding='utf-8', index=False)
