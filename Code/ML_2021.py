...
#Fusion_App = Fusion[(Fusion['ffctyploc'] == 2)]
#Fusion_Mais = Fusion[(Fusion['ffctyploc'] == 1)]
#%%
...
#%%Prédiction
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R24.csv",sep = ",")
...
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 18 777.18€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 299.04€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 4 227.58€ du m²
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R11.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Etage_Max_pred = Fusion_1_Pred['nbetagemax']
Etage_Max_pred = pd.DataFrame(Etage_Max_pred)
Etage_Max_pred = Etage_Max_pred.rename(columns={'nbetagemax': 'Etage'})
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 13 293.21€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 459;57€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 5 082.70 du m²
Fusion_1_Pred = Fusion_1_Pred.drop(columns=['Dep'])
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2022/Fusion_predict_R_11.csv', sep=',', encoding='utf-8', index=False)
...
Fusion_pred = Fusion_pred[(Fusion_pred['Dep'] == "75")]
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
                            (Fusion_pred['npiece_ff']> 0)]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 17 114.43€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5 749.99€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 10 695€ du m²
Fusion_1_Pred = Fusion_1_Pred.drop(columns=['Dep'])
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R27.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9 141.40€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 52.10€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 1 579.13€ du m²
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R28.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 7 533.12€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 360€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 2 072.80€ du m²
Fusion_1_Pred = Fusion_1_Pred.drop(columns=['Dep'])
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R32.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 18 519€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 241.51€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 1969.78€ du m²
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 5 447.09€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 222.53€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 1 531.80€ d%u m²
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R52.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9 800.75 du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 273.69 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 2 528.18€ du m²
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R53.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 11 272.33€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 381.06 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 2 500.51€ du m²
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R75.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 23 259.05€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 358.12 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 2 485.72€ du m²
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R76.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 6 545.44€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 98.83 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 2 227.69€ du m²
...
Fusion = Fusion[(Fusion['libnatmut'] == 'Vente')]
Fusion = Fusion[(Fusion['datemut'] >= '2022-01-01') & (Fusion['datemut'] < '2023-01-01')]
Fusion = Fusion[(Fusion['ffcodinsee'] != "73290")&(Fusion['ffcodinsee'] != "03185")]
list(Fusion.columns)
Aires_urbaines = pd.read_excel('C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Corr_code_insee_EPCI.xlsx')
Fusion = pd.merge(Fusion, Aires_urbaines, how="left", on=['ffcodinsee'])
Fusion = Fusion.dropna()
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R84.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 28 233.44€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 130.35 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 2 746.48€ du m²
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R93.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 26 782.59€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 250.61 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 3 463.59€ du m²
...
Fusion = Fusion[(Fusion['libnatmut'] == 'Vente')]
Fusion = Fusion[(Fusion['datemut'] >= '2022-01-01') & (Fusion['datemut'] < '2023-01-01')]
Fusion = Fusion[(Fusion['ffcodinsee'] != "2A066")&(Fusion['ffcodinsee'] != "2A363")]
list(Fusion.columns)
Aires_urbaines = pd.read_excel('C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Corr_code_insee_EPCI.xlsx')
Fusion = pd.merge(Fusion, Aires_urbaines, how="left", on=['ffcodinsee'])
Fusion = Fusion.dropna()
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/R94.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
