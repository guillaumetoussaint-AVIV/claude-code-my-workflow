...
#%%Prédiction
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R24.csv",sep = ",")
...
Floor_pred_mais = Floor_pred_mais.drop(1, axis = 1)
Floor_pred_mais = Floor_pred_mais.rename(columns={2: 'Appartement'})
Etage_Max_pred = pd.concat([Fusion_1_Pred['dnbniv'],Floor_pred_mais], axis = 1)
Etage_Max_pred = Fusion_1_Pred['dnbniv']*Etage_Max_pred['Appartement']
...
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.92€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7,23€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_24.csv', sep=',', encoding='utf-8')
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R11.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 9.16€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.87€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 8.07 du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_11.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R11_75.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
...
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 8.36€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 9.03€ du m²
Fusion_1_Pred = Fusion_1_Pred.drop(columns=['Dep'])
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_Paris.csv', sep=',', encoding='utf-8', index=False)
...
print('R² is: '+str(round(r2_score(y_test,model.predict(X_test)),2)))
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R27.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.52 du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.03€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.09€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_27.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R28.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 6.28€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.32€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_28.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R32.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.64€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.59€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.32€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_32.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R44.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.08€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.65€ du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.07€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_44.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R52.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.80 du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.52 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.43€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_52.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R53.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.40€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.70 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.31€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_53.csv', sep=',', encoding='utf-8', index=False)
#%%
#%%Nouvelle Aquitaine
Fusion = pd.concat([Fusion_d01_d21, Fusion_d22_d40, Fusion_d41_d60, Fusion_d61_d80, Fusion_d81_d974], axis = 0)
Fusion['ffcodinsee'] = Fusion['ffcodinsee'].apply(lambda x: '{0:0>5}'.format(x))
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R75.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.81€
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.05€
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.29€
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_75.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R76.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)]
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.57€ m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min:  5.24€ m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.36€ m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_76.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R84.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
#Fusion_pred = Fusion_pred[(Fusion_pred['loghlls'] != 'OUI') & (Fusion_pred['loghlls'] != 'OUI PROBABLE')]
#Fusion_pred_1.shape[0]/Fusion_pred.shape[0]
#Fusion_pred.shape[0]-Fusion_pred_1.shape[0]
...
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.47€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_84.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R93.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 10.33€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.27 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.89€ du m²
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_93.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R94.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.52€ du m²
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 6.02 du m²
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.61€ du m²
Fusion_1_Pred = Fusion_1_Pred[(Fusion_1_Pred['Predicted_price_sq_m'] > 0)]
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_94.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R01.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.35
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 4.94
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.28
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_01.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R02.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.26
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 4.93
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.33
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_02.csv', sep=',', encoding='utf-8', index=False)
...
#%%
Fusion_pred = pd.read_csv("C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Input prédictions/2012/R04.csv",sep = ",")
Fusion_pred['idcom'] = Fusion_pred['idcom'].apply(lambda x: '{0:0>5}'.format(x))
Fusion_1_Pred = Fusion_pred[(Fusion_pred['stoth'] >= 9)&
                            (Fusion_pred['stoth'] <= 1000)&
                            (Fusion_pred['jannath'] > 0)&
...
Fusion_1_Pred.reset_index(drop=True, inplace=True)
Fusion_1_Pred = pd.concat([y_pred, Fusion_1_Pred], axis = 1)
np.max(Fusion_1_Pred['Predicted_price_sq_m'])#Max: 8.43
np.min(Fusion_1_Pred['Predicted_price_sq_m'])#Min: 5.61
mean(Fusion_1_Pred['Predicted_price_sq_m'])#Moyenne : 7.44
Fusion_1_Pred.to_csv(r'C:/Users/guill/Desktop/Master APE/Doctorat/Thèse cifre/Valorisation/Données/Bases prédites/2012/Fusion_predict_R_04.csv', sep=',', encoding='utf-8', index=False)
